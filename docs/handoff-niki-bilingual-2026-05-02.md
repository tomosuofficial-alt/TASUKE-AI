...
Niki★DINER の商品画像投稿は、しばらく「商品写真だけに絞った統一感ある投稿」を優先する。

参考アカウント:
- `@junksmashburgers`
- https://instagram.com/junksmashburgers

既存のミセル生成プロンプトで使っていた方向性:
- `@junksmashburgers系 NY smashburger documentary`
- `dark & moody, cinematic, orange × teal LUT`
...
- 実物以上に盛る
- 別商品のように見える加工
- 販売対象の商品写真を実物っぽく AI 合成する

方針:
- Prosnap など実物写真をベースにする
- 料理の形状・量・質感・具材は変更しない
- 許容する加工はクロップ、リフレーム、背景調整、露出・色味の軽い補正まで
- キャプションはハッシュタグなし。日本語の後に英語を追記し、改行を使って読みやすくする
